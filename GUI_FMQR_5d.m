function varargout = GUI_FMQR_5d(varargin)
% GUI_FMQR_5D MATLAB code for GUI_FMQR_5d.fig
%      GUI_FMQR_5D, by itself, creates a new GUI_FMQR_5D or raises the existing
%      singleton*.
%
%      H = GUI_FMQR_5D returns the handle to a new GUI_FMQR_5D or the handle to
%      the existing singleton*.
%
%      GUI_FMQR_5D('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_FMQR_5D.M with the given input arguments.
%
%      GUI_FMQR_5D('Property','Value',...) creates a new GUI_FMQR_5D or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_FMQR_5d_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_FMQR_5d_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_FMQR_5d

% Last Modified by GUIDE v2.5 29-Jun-2020 11:50:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_FMQR_5d_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_FMQR_5d_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_FMQR_5d is made visible.
function GUI_FMQR_5d_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_FMQR_5d (see VARARGIN)

% Choose default command line output for GUI_FMQR_5d
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUI_FMQR_5d wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_FMQR_5d_OutputFcn(hObject, eventdata, handles) 
...
Retrieved_Items(end+1,:) = queryIndex5;
...
dist_f5 = pdist2(f5 , rtr_idx2_features , 'euclid' );
