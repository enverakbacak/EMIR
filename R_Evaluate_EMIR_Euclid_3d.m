...
filenames = filenames;
N = length(filenames);
queryIndex = xlsread('/home/ubuntu/Desktop/Thesis_Follow_Up_2/dmqRetrieval/lamdaDataset/qLabels_3d.xls');  % Reads randomly choosen query pairs from excell filequeryIndex = transpose( queryIndex ); 
%}
...
data = hashCodes_128;
load('/home/ubuntu/keras/enver/dmlvh2/DMQVR/myDataset2/features/features_128.mat');
...
data = hashCodes_64;
data = max(data,0);
load('Barcelona/features/features_32.mat');
